...
## 2026-09-05 merge shared-bus HX landing-gear servos

- [x] Create isolated worktree `PX4-Autopilot-testc4-hx-servos` and verify the
      target `96f3b716585996d5b5aeeca4d2d509b2451cceca`, source parent
      `285a9d5716e6f2935545532350645044a52ad11b`, and source endpoint
      `23d274ea60a7b7d9c408dc9866de905f84b1ff98`.
- [x] Semantically merge the HX8/HX-65HM shared 1 Mbps UART driver, mixed
      transformation/landing-gear sequence, safety checks, uORB status and
      parameters while preserving testc4 command-50000 lifecycle, Rover
      Offboard epoch gating and tuning streams.
- [x] Preserve the 14-byte HX8 command `0x0e` payload and the HX-65HM parser,
      retry, resynchronization and cross-protocol bus-quiet behavior.
- [x] Verify that the MAVLink gitlink remains `21922689c6fb113884df0f66582d8e602286fdc1`
      and that no MAVLink source, stream table or uXRCE-DDS topic list changes
