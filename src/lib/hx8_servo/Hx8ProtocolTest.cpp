...
TEST(Hx8Protocol, EncodesOfficialAndVendorGoldenRequests)
{
	...
	const uint8_t multi_turn_payload[] {0x70, 0x17, 0x00, 0x00, 0xb0, 0x04, 0x00, 0x00,
					    0x64, 0x00, 0x64, 0x00, 0x00, 0x00
					   };
	const uint8_t multi_turn_move[] {0x12, 0x4c, 0x0e, 0x0f, 0x00, 0x70, 0x17, 0x00, 0x00, 0xb0,
					 0x04, 0x00, 0x00, 0x64, 0x00, 0x64, 0x00, 0x00, 0x00, 0x7e
					};
	expectEncoded(CommandId::TimedMultiTurnMove, 0, multi_turn_payload, sizeof(multi_turn_payload),
		      multi_turn_move, sizeof(multi_turn_move));
